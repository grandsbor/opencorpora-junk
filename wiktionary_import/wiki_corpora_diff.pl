...
$corpora_dictionary_file = "D:/dict.opcorpora.xml";
$wiki_dictionary_file = "D:/ruwiktionary-20121028-pages-articles.xml";
$corpora_text_file = "D:/annot.opcorpora.xml";

$wiki_dictionary_file_chop = "D:/ruwiktionary-20121028-pages-articles_chop.xml";
#util::chop_wiki($wiki_dictionary_file, $wiki_dictionary_file_chop);
...
$dir = "./data/";
$diff_wiki_corpora = $dir."diff.txt"; # слова, которые есть в вики, но нет в OpenCorpora
$diff_wiki = $dir."wiki_of_diff.xml"; # дамп, в котором есть только неизвестные слова
